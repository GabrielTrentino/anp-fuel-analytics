...
1. `movimentacao-derivados` — complemento natural da tancagem  
2. `cadastro-revendas-combustiveis` — geografia do varejo  
3. `serie-historica-precos` — série temporal  
4. `vendas-derivados` — demanda agregada  
5. `pmqc` — qualidade  
